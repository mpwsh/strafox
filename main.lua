...
function initializeGameState()
	return {
		...
		menuOptions = {
			{ name = "Master Volume", value = 0.4 },
			{ name = "Music Volume", value = 0.1 },
			{ name = "SFX Volume", value = 0.3 },
		},
		menuBlinkTimer = 0,
		showMenuCursor = true,
	}
...
function love.load()
	...
	effect = moonshine(moonshine.effects.crt).chain(moonshine.effects.filmgrain).chain(moonshine.effects.glow)
